...
- [ ] Feature file: NEEDS CREATION
- [🔄] Related machine: `/home/user/PAA/src/workflows/education/allocationEtudesMachine.ts`
...
- [ ] Feature file: NEEDS CREATION
- [🔄] Related machine: `/home/user/PAA/src/workflows/handicap/allocationIntegrationMachine.ts`
...
- [ ] Feature file: NEEDS CREATION
- [🔄] Machine: `/home/user/PAA/src/workflows/pension/grapaMachine.ts`
...
- [ ] Feature file: NEEDS CREATION
- [🔄] Machine: `/home/user/PAA/src/workflows/education/allocationEtudesMachine.ts`
...
- [ ] Feature file: NEEDS CREATION
- [🔄] Related machine: `/home/user/PAA/src/workflows/family/congeParentalMachine.ts`
...
- [ ] Feature file: NEEDS CREATION
- [🔄] Machine: `/home/user/PAA/src/workflows/health/accidentTravailMachine.ts`
...
- [ ] Feature file: NEEDS CREATION
- [🔄] Machine: `/home/user/PAA/src/workflows/pension/pensionAnticipeeMachine.ts`
...
- [ ] Feature file: NEEDS CREATION
- [🔄] Machine: `/home/user/PAA/src/workflows/housing/agenceImmobiliereSocialeMachine.ts`
...
- [ ] Feature file: NEEDS CREATION
- [🔄] Machine: `/home/user/PAA/src/workflows/family/congeParentalMachine.ts`
...
- [ ] Feature file: NEEDS CREATION
- [🔄] Machine: `/home/user/PAA/src/workflows/health/maladieProfessionnelleMachine.ts`
...
- [ ] Feature file: NEEDS CREATION
- [🔄] Machine: `/home/user/PAA/src/workflows/chequesRepasMachine.ts`
...
- [ ] Feature file: NEEDS CREATION
- [🔄] Machine: `/home/user/PAA/src/workflows/aideAlimentaireMachine.ts`
...
- [ ] Feature file: NEEDS CREATION
- [🔄] Machine: `/home/user/PAA/src/workflows/ecoChequeMachine.ts`
...
- [⚠] Rule file: `/home/user/PAA/src/rules/abonnementSocialTransportRules.ts`
- Need feature file
- Income-based subsidized public transit pass

### Carte Médicale (Medical Card)
- [⚠] Rule file: `/home/user/PAA/src/rules/carteMedicaleRules.ts`
