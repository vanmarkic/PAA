...
export { allocationIntegrationMachine } from './handicap/allocationIntegrationMachine';
...
export { accidentTravailMachine } from './health/accidentTravailMachine';
export { maladieProfessionnelleMachine } from './health/maladieProfessionnelleMachine';
