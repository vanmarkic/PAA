/**
 * Business Rules for CongeParental
 *
 * Implements eligibility rules for CongeParental.
 *
 * BASE JURIDIQUE:
...
function createCongeParentalEngine(): Engine {
  ...
  engine.addRule({
    ...
    event: {
      ...
      params: {
        message: 'Éligible pour CongeParental',
      },
    },
    priority: 5,
  });
...
/**
 * Calculate CongeParental amount
 */
...
/**
 * Check CongeParental eligibility
 */
export async function checkCongeParentalEligibility(
  ...
  try {
    ...
    throw new Error(`Error checking CongeParental eligibility: ${error}`);
  }
}
 ...
 */
export const CONGEPARENTAL_RULES_JSON = {
  legalFramework: {
    note: 'Base juridique à compléter',
  },
  rules: [
    {
      id: 'congeParental-basic-eligibility',
