 ...
 *
 * Validates internal links in HTML files for SSG sites.
 * Used by the validate-links script and tests.
 */
 ...
 */
export function validateLinks(options: ValidationOptions): { valid: number; invalid: number; external: number; anchor: number; skipped: number } {
  const stats = {
    valid: 0,
    invalid: 0,
    external: 0,
