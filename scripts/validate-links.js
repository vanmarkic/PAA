 ...
 */
function anchorExists(html, anchorId) {
 ...
 */
function resolveLink(link, currentFile, basePath, distDir) {
    // Skip external links
 ...
 */
function fileExists(filePath, distDir) {
 ...
 */
function validateFileLinks(filePath, options) {
    const results = [];
 ...
 */
function validateLinks(options) {
    const stats = {
        valid: 0,
        invalid: 0,
        external: 0,
